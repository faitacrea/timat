...
import {
  ALLOC_FORMATION_H, AvatarEnfant, AvatarPicker, BILANS, BORNE_BLOCAGE_MS, BORNE_ESSAIS_MAX, Bilans, CATS, CPill, D, DOCS_DEMO, EmptyState, FERIES_2024, H, HEURES_TYPES, Icone, IconeOuEmoji, JOURS_SEM, Journal, LIMITE_ENFANTS_GRATUIT, PageHeader, Pastille, PastilleRepas, Portfolio, QRPointage, QUALITE_REPAS, RETENUE_TYPES, SEMAINES_MAX_ANNEE_INCOMPLETE, Sommeil, THEMES_CAL, TYPES_EV, Toast, URL_CONVENTION, VACANCES_2024, borneCodeSortie, borneEmpreintes, borneFermer, borneMemoriserEmpreintes, borneOuvrir, empreinteCode, estPro, fileHorsLigne, filerOperation, fmt, fmtDateHeureCourte, heuresMensualisees, isVacances, isoJour, lireHorsLigne, memoriserHorsLigne, minimumHoraireAu, nb2, nbf, netDepuisBrut, nomVacances, qrSvgBalise, salaireMensualise, semainesDuContrat, tirerJetonBorne, typeEv, G, TODAY_STR
} from "./App.jsx";
