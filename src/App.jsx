      ...
      <div className="lp-hero" style={{ background: L.heroBg }}>
        ...
        <div className="lp-hero-grid" style={{ position: "relative", zIndex: 1 }}>
          <div className="lp-hero-text" style={{ textAlign: L.heroAlign||"center" }}>
            <div style={{ maxWidth: isWeb?(L.heroTitleMaxW||620):"none", marginLeft:"auto", marginRight:"auto", fontFamily: fTitle, fontSize: "clamp(24px,4.4vw,50px)", fontWeight: 700, color: L.heroTitleColor||"#2E4859", lineHeight: 1.14, marginBottom: 16 }}>
              {T.heroTitle}<br/>
...
const _quotidien = () => import("./ecrans-quotidien.jsx");
